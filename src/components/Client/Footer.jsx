                ...
                <div className=" pt-36">
                    ...
                    <div className="flex flex-col flex-wrap  items-center md:justify-between  md:flex-row md:items-start">
                        ...
                        <div className="flex justify-center flex-wrap">
                            <Icon src={visa} alt="visa icon" />
                            <Icon src={masterCard} alt="masterCard icon" />
                            <Icon src={paypal} alt="paypal icon" />
                            <Icon src={applePay} alt="applePay icon" />
                            <Icon src={Gpay} alt="Google Pay icon" />
                        </div>
                    </div>
                </div>
            </div>
